...
<div class="container-fluid">
    <div class="row">
        <nav id="siderbarMenu" class="col-md-3 col-lg-2 d-md-block bg-light siderbar collapse">
    ...
    <div class="table-responsive">
        ...
        <div class="form-floating">
            <input type="number" class="form-control" id="floatingInput" placeholder="Surname" name="surname" value="<?php echo $user_data['surname']?>">
            <label for="floatingInput>">Surname</label>
        </div>
        <div class="form-floating">
            <input type="number" class="form-control" id="floatingInput" placeholder="Username" name="id" value="<?php echo $user_data['username']?>">
